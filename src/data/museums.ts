...
const sceneAssets = [
  ['1', 'Area 1 · Gerbang Masuk', '01-1.webp', 'Gerbang merah besar Museum Mpu Tantular. Di depan terdapat papan nama museum, area parkir, dan jalan masuk beraspal. Lanjut ke depan untuk memasuki area museum.'],
  ['2', 'Area 2 · Halaman Depan', '02-2.webp', 'Halaman terbuka di depan gedung museum. Terdapat arca Dwarapala dan Lingga Yoni di sisi kanan dan kiri. Dua jalur tersedia: ke kanan menuju rute utama, ke kiri menuju sayap barat.'],
  ['3-ke-kanan', 'Area 3 · Sayap Timur', '03-3-ke-kanan.webp', 'Koridor sisi timur museum dengan pepohonan rindang. Dari sini bisa belok kanan menuju area pamer dalam, atau lurus menuju Area 10.'],
  ['3-ke-kiri', 'Area 3 · Sayap Barat', '04-3-ke-kiri.webp', 'Koridor sisi barat museum. Jalur ini mengarah lurus menuju Area 4 dan ruang pamer fosil.'],
  ['4', 'Area 4 · Persimpangan Utama', '05-4.webp', 'Persimpangan koridor dalam museum. Lurus menuju ruang fosil (Area 5), merupakan jalur utama tur.'],
  ['4-ke-kanan', 'Area 4 · Lorong Timur', '06-4-ke-kanan.webp', 'Lorong sisi timur dengan dua pilihan: lurus menuju ruang transportasi kuno, atau belok ke area aksesibel tunanetra.'],
  ['5', 'Area 5 · Ruang Fosil', '07-5.webp', 'Ruang pamer utama berisi koleksi fosil prasejarah: fosil Bofidae, fosil kerbau, tengkorak manusia purba, dan batuan purba. Penerangan cukup terang dengan vitrin kaca di sepanjang dinding.'],
  ['5-ke-kanan-terus-lurus', 'Area 5 · Ruang Transportasi Kuno', '08-5-ke-kanan-terus-lurus.webp', 'Ruang pamer transportasi tradisional berisi cikar dan dokar (kereta kuda). Artefak dipajang di area terbuka dengan pencahayaan alami dari jendela samping.'],
  ['5-masuk-tunanetra', 'Area 5 · Ruang Aksesibel Tunanetra', '09-5-masuk-tunanetra.webp', 'Ruang khusus aksesibilitas tunanetra. Terdapat display tentang Louis Braille, pesawat telepon kuno, dan lampu gantung bersejarah. Ruangan ini dirancang dengan pencahayaan lembut dan label braille.'],
  ['6-ke-kanan', 'Area 6 · Galeri Arkeologi', '10-6-ke-kanan.webp', 'Galeri arkeologi dengan koleksi fosil kayu jati, arca Ganesa, dan hiasan Garudeya. Vitrin kaca berjajar di kedua sisi lorong. Bisa belok kiri ke galeri Hindu-Buddha atau lurus ke Area 7.'],
  ['6-ke-kiri', 'Area 6 · Galeri Hindu-Buddha', '11-6-ke-kiri.webp', 'Ruang pamer artefak Hindu-Buddha berisi Moko, benda terakota peninggalan Majapahit, Pantheon dewa Buddha, sarana upacara, dan koleksi pameran lainnya. Suasana tenang dengan pencahayaan redup.'],
  ['7', 'Area 7 · Ruang Maritim & Senjata', '12-7.webp', 'Ruang pamer berisi Kerapan Sapi, maket kapal dagang Insulinde, meriam Lela, dan kentongan Thuk-thuk. Area ini luas dengan langit-langit tinggi. Dua arah: keluar ke koridor atau lurus ke area berikutnya.'],
  ['8-keluar', 'Area 8 · Koridor Keluar', '13-8-keluar.webp', 'Koridor penghubung menuju area luar. Dari sini bisa lanjut ke Area 9 untuk melanjutkan tur.'],
  ['8-lurus', 'Area 8 · Ruang Tekstil & Seni', '14-8-lurus.webp', 'Ruang pamer tekstil berisi batik pesisiran Jawa Timur, topeng Malang, dan wayang beber. Kain-kain dipajang dalam bingkai kaca sepanjang dinding. Lurus menuju tangga ke lantai atas.'],
  ['9', 'Area 9 · Zona Transisi', '15-9.webp', 'Area transisi dekat prasasti Kamalgyan. Lorong ini menghubungkan lantai bawah ke jalur naik tangga menuju lantai atas museum.'],
  ['9-lurus-naik-tangga', 'Area 9 · Tangga Naik ke Lantai 2', '16-9-lurus-naik-tangga.webp', 'Area tangga menuju lantai atas. Di sepanjang tangga terdapat kipas angin tenaga uap, mesin ketik antik, dan sepeda motor Daimler. Zona IPTEK dimulai dari sini.'],
  ['10', 'Area 10 · Galeri Lantai Atas', '17-10.webp', 'Galeri di lantai atas museum. Area ini lebih terang dengan jendela besar. Lurus menuju ruang koleksi modern, belok kiri menuju tangga ke lantai paling atas.'],
  ['10-ke-kiri', 'Area 10 · Lorong ke Lantai 3', '18-10-ke-kiri.webp', 'Lorong menuju tangga naik ke area paling atas museum. Lorong sempit dengan penerangan dari lampu dinding.'],
  ['10-lurus', 'Area 10 · Ruang Koleksi Modern', '19-10-lurus.webp', 'Ruang pamer berisi kapal Maru, mesin ketik, dan sepeda tinggi. Koleksi teknologi dan transportasi era kolonial dipajang dalam vitrin besar.'],
  ['11', 'Area 11 · Galeri Akhir Lantai 2', '20-11.webp', 'Galeri bagian akhir lantai 2. Dari sini bisa lanjut naik tangga ke lantai paling atas atau menjelajah ruang lurus.'],
  ['11-lurus', 'Area 11 · Ruang Militer', '21-11-lurus.webp', 'Ruang pamer militer berisi maket kapal pemburu torpedo Lynx. Ruangan ini memiliki pencahayaan dramatis yang menyoroti model kapal.'],
  ['12-naik-tangga', 'Area 12 · Tangga ke Lantai Atas', '22-12-naik-tangga.webp', 'Area tangga menuju lantai paling atas. Tangga cukup lebar dengan pegangan di kedua sisi.'],
  ['13', 'Area 13 · Ruang Kesenian (Akhir Tur)', '23-13.webp', 'Ruang kesenian di lantai paling atas — titik terakhir tur. Berisi jaran kencak, reog, dan koleksi kesenian tradisional Jawa Timur lainnya. Ruangan luas dengan langit-langit tinggi.'],
] as const;
